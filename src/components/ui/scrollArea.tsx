...
export const ScrollAreaRoot = React.forwardRef<React.ElementRef<typeof ScrollArea.Root>, React.ComponentPropsWithoutRef<typeof ScrollArea.Root>>(
	({ className, ...props }, ref) => (
		<ScrollArea.Root
			ref={ref}
			className={cn('w-[200px] h-[225px] rounded overflow-hidden shadow-[0_2px_10px] shadow-blackA4 bg-white', className)}
			{...props}
		/>
	)
)
...
>(({ className, ...props }, ref) => <ScrollArea.Viewport ref={ref} className={cn('w-full h-full rounded', className)} {...props} />)
...
export const ScrollAreaThumb = React.forwardRef<React.ElementRef<typeof ScrollArea.Thumb>, React.ComponentPropsWithoutRef<typeof ScrollArea.Thumb>>(
	({ className, ...props }, ref) => (
		<ScrollArea.Thumb
			ref={ref}
			className={cn(
...
>(({ className, ...props }, ref) => <ScrollArea.Corner ref={ref} className={cn('bg-blackA5', className)} {...props} />)
