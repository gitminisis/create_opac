		...
		<div
			...
			<div
				...
				<div role="status" className={'text-lg '}>
					<svg
						aria-hidden="true"
						className={`${spinWidth} ${spinHeight} text-gray-200 animate-spin dark:text-gray-600 fill-neutral-100`}
						viewBox="0 0 100 101"
						fill="none"
				...
				<div className="text-black text-2xl mt-2 text-white">Loading...</div>
			</div>
		</div>
	)
}
